...
const teamMembers = [
  {
    ...
    expertise: "End-to-end AI systems, FastAPI backends & React/Next.js frontends",
    image: null,
    social: {
      github: "https://github.com/AryanG2311",
      linkedin: "https://www.linkedin.com/in/aryan-goel-487775351/",
      email: "aryan@swastha.ai",
    },
  },
  {
    name: "Aryan Kumar Sharma (TBD)",
    role: "Co-Founder & Developer",
    expertise: "To be updated soon",
    image: null,
    social: {
      github: "",
      linkedin: "",
      ...
      <div className="container mx-auto px-6">
        ...
        <div className="text-center mb-16 animate-fade-in-up">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            A passionate team of students combining technology and healthcare to make anaemia
            screening accessible to every teenager.
          </p>
        </div>
        ...
        >
          {stats.map((stat, index) => (
            <Card
              key={index}
              className="glass-card border-2 border-primary/20 hover-glow text-center"
            >
        ...
        {/* Team Members */}
        <div
          className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16 animate-fade-in-up"
          style={{ animationDelay: "0.4s" }}
        >
          {teamMembers.map((member, index) => (
            <Card
              key={index}
              className="glass-card border-2 border-accent/20 hover-lift hover-glow transition-all duration-300 overflow-hidden"
            >
              <CardContent className="p-0">
                {/* Profile "Image" area (placeholder) */}
                <div className="relative h-48 overflow-hidden flex items-center justify-center bg-gradient-to-br from-primary/20 to-accent/20">
                  ...
                  <div className="absolute bottom-4 left-4 right-4 flex gap-2 justify-center">
                    {member.social.github && (
                      ...
                      >
                        <Button
                          size="sm"
                          className="bg-white/20 backdrop-blur-sm text-white hover:bg-white/30 p-2 h-auto"
                        >
